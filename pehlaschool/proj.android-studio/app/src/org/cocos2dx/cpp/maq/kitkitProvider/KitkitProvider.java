package org.cocos2dx.cpp.maq.kitkitProvider;
...
public class KitkitProvider extends ContentProvider {
    ...
    public static Uri CURRENT_USER_URI;
    public static Uri SNTP_RESULT_URI;
    public static Uri PREFERENCE_URI;
    public static Uri FISHES_URI;
    private static String AUTHORITY; // to fetch the app flavor
    private KitkitDBHandler myDB;

    @Override
    public boolean onCreate() {

        // Get the correct locale code for the provider name
        AUTHORITY = "com.maq.provider.pehlaschool" + getContext().getPackageName().substring(19);

        CONTENT_URI = Uri.parse("content://" + AUTHORITY + "/" + USER_TABLE);
        CURRENT_USER_URI = Uri.parse("content://" + AUTHORITY + "/" + CURRENT_USER_TABLE);
        SNTP_RESULT_URI = Uri.parse("content://" + AUTHORITY + "/" + SNTP_RESULT_TABLE);
        PREFERENCE_URI = Uri.parse("content://" + AUTHORITY + "/" + PREFERENCE);
        FISHES_URI = Uri.parse("content://" + AUTHORITY + "/" + FISHES_TABLE);
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        ...
        switch (uriType) {
            ...
            case PREFERENCE_INFO:
                ...
                cursor.addRow(new String[]{tabletNumber});
                return cursor;
            case FISHES:
