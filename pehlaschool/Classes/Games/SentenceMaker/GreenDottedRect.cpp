...
GreenDottedRect* GreenDottedRect::create(Size prefferedSize)
{
    GreenDottedRect *popup = new (std::nothrow) GreenDottedRect();
...
bool GreenDottedRect::init(Size prefferedSize)
{
    if (!Node::init()) {
        return false;
    }
    ...
    Texture2D *horiTex = TextureCache::getInstance()->addImage("SentenceMaker/dotted_line_16_hori.png");
    horiTex->setTexParameters(params);
    
    Texture2D *vertTex = TextureCache::getInstance()->addImage("SentenceMaker/dotted_line_16_vert.png");
    ...
    //auto c1 = Sprite::create("Game/SentenceMaker/dotted_line_16_corner.png", Rect(0, 0, cornerWidth, cornerWidth));
    auto c1 = Sprite::create("SentenceMaker/dotted_line_16_corner.png",  Rect(0, cornerWidth, cornerWidth, cornerWidth));
    ...
    auto c2 = Sprite::create("SentenceMaker/dotted_line_16_corner.png", Rect(cornerWidth, cornerWidth, cornerWidth, cornerWidth));
    ...
    auto c3 = Sprite::create("SentenceMaker/dotted_line_16_corner.png", Rect(0, 0, cornerWidth, cornerWidth));
    ...
    auto c4 = Sprite::create("SentenceMaker/dotted_line_16_corner.png", Rect(cornerWidth, 0, cornerWidth, cornerWidth));
