...
//    if (cur->categoryLevel==0) panelName += "prek.png";
    ...
    auto panelLabel = TodoUtil::createLabel(levelTitle, 50, Size::ZERO, arialFont, Color4B(255, 249, 235, 255));
    ...
    */
    {
        auto descLabel = TodoUtil::createLabel(s1, 35, Size::ZERO, arialFont, Color4B(65, 5, 5, 255), TextHAlignment::CENTER);
