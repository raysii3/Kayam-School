...
//        String info = bundle.getString("videoInfo");
        ...
        TextView expandableTitleTV = findViewById(R.id.video_title_expandable);
        expandableTitleTV.setText(videoTitle);

        TextView lyricsTV = findViewById(R.id.video_lyrics_expandable);
        lyricsTV.setText(lyrics);

        TextView infoTV = findViewById(R.id.video_info_expandable);
        infoTV.setText(info);
...
//            player.setOnPreparedListener(this);
    ...
    private void setNextVideo() {
        ...
        nextLinearLayout = findViewById(R.id.next_video_layout);
        ...
        try {
            ...
            TextView nextTitleTV = findViewById(R.id.next_video_title_textView);
            nextTitleTV.setText(nextVideo.title);

            ImageButton nextVideoButton = findViewById(R.id.next_video_thumbnail);
            Drawable thumbnail;
            if (MainActivity.useExternalData) {
