...
void TextBlock::initAsBlock(std::string text)
{
    ...
    auto shadow = Scale9Sprite::create("lrcomprehension/common/comprehention_filltheblank_wordcard_shadow.png");
...
//    addChild(_shadow);
    ...
    auto face = Scale9Sprite::create("lrcomprehension/common/comprehention_filltheblank_wordcard.png");
