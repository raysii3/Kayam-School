...
void ImageAndImageLayer::setQuestionImage(std::string imageFile)
{
    auto backgroundSprite = Sprite::create("lrcomprehension/common/comprehention_multiplechoice_img.png");
    ...
    auto questionSprite = Sprite::create("lrcomprehension/images/" + imageFile);
    ...
    auto frameSprite = Sprite::create("lrcomprehension/common/comprehention_multiplechoice_img_border.png");
...
void ImageAndImageLayer::setAnswers(std::vector<std::string> imageFiles)
{
    ...
    if (imageFiles.size() > 0)
    {
        ...
        item->initImage(imageFiles[0], 30.f, 50.f);
    ...
    for (int i = 0; i < imageFiles.size(); i++)
    {
        ...
        bool bInit = item->initImage(imageFiles[i], 30.f, 50.f);
