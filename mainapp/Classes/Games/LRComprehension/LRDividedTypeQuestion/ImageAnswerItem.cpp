...
bool ImageAnswerItem::initImage(std::string image, float marginX, float marginY)
{
    _id = image;
    
    setContentSize(kImageSize);
    
    _normalAnswerSprite = Scale9Sprite::create("lrcomprehension/common/comprehensivequiz-multiple-choice-normal.png");
    ...
    _wrongAnswerSprite = Scale9Sprite::create("lrcomprehension/common/comprehensivequiz-multiple-choice-wrong.png");
    ...
    _rightAnswerSpriteBg = Scale9Sprite::create("lrcomprehension/common/comprehensivequiz-multiple-choice-picture-correct-bg.png");
    ...
    _answerSprite = Sprite::create("lrcomprehension/images/" + image);
    ...
    _rightAnswerSprite = Scale9Sprite::create("lrcomprehension/common/comprehensivequiz-multiple-choice-picture-correct.png", Rect(0, 0, 180, 180), Rect(126, 131, 14, 9));
...
{
    GameSoundManager::getInstance()->playEffectSound("LRComprehension/common/card_miss.m4a");
