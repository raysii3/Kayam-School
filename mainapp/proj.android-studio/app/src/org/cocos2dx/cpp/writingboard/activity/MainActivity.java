package org.cocos2dx.cpp.writingboard.activity;
...
import org.cocos2dx.cpp.writingboard.util.Font;
import org.cocos2dx.cpp.writingboard.util.Log;
import org.cocos2dx.cpp.writingboard.util.Preference;
import org.cocos2dx.cpp.writingboard.util.Util;
import org.cocos2dx.cpp.writingboard.view.ViewDrawingColoring;
import org.cocos2dx.cpp.writingboard.view.base.SwipeViewPager;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (size.x <= 1280) {
            setContentView(R.layout.activity_main_writing_board);
            mbSmall = true;
        } else {
            setContentView(R.layout.activity_main_writing_board);
        }
