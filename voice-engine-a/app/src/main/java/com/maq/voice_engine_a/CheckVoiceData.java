...
public class CheckVoiceData extends Activity {
    ...
    // NB(xenosoz, 2018): Got ENOENT for some path below on Nexus 7.
    //private final static String PICO_LINGWARE_PATH = Environment.getExternalStorageDirectory() + "/svox/";
    //private final static String PICO_LINGWARE_PATH = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS) + "/svox/";
    //private final static String PICO_LINGWARE_PATH = "/sdcard/svox/";
    private String PICO_LINGWARE_PATH() {
        File path = this.getApplicationContext().getExternalFilesDir(null);
        if (path == null) {
            Log.e(TAG, "PICO_LINGWARE_PATH: is null");
            return "/sdcard/svox";
        }
    ...
    private final static String PICO_SYSTEM_LINGWARE_PATH = "/system/tts/lang_pico/WE_WILL_IGNORE_THIS_PATH";
