...
package com.maq.voice_engine_a.core;
...
public abstract class CompatTtsService extends TextToSpeechService {
    ...
    private static final String TAG = "CompatTtsServiceA";
    ...
    protected int onIsLanguageAvailable(String lang, String country, String variant) {
        ...
        if (DBG) Log.d(TAG, "onIsLanguageAvailable: mNativeSynth:" + String.valueOf(mNativeSynth != null));
        if (mNativeSynth == null) return TextToSpeech.ERROR;
        //return TextToSpeech.LANG_COUNTRY_AVAILABLE;  // XXX
    ...
    protected int onLoadLanguage(String lang, String country, String variant) {
        ...
        if (DBG) Log.d(TAG, "onLoadLanguage returns: " + String.valueOf(result));
